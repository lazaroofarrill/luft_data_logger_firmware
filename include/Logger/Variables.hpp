...
//++ Humedad
    ...
    void Humd_Relativa_Porciento() {  //200
        Canal = 200;
...
//++ Enthalpy
    ...
    void specific_enthalpy_KJ_Kg() {  //215
        Canal = 215;
...
//++ Velocidad del Viento
    ...
    void wind_speed_standard_deviation_mXs() {  //403
        Canal = 403;
        Rango_Medicion_Min = 0;
        Rango_Medicion_Max = 75;
    ...
    void wind_speed_standard_deviation_mpH() {  //413
        Canal = 413;
        Rango_Medicion_Min = 0;
        Rango_Medicion_Max = 167.8;
...
//++ Direccion del Viento
    ...
    void wind_direction_Grados() {  //500
        Canal = 500;
        Rango_Medicion_Min = 0;
    ...
    void wind_direction_Fast_Grados() {  //501
        Canal = 501;
        Rango_Medicion_Min = 0;
        Rango_Medicion_Max = 359.9;
    ...
    void wind_direction_Corr_Grados() {  //502
        Canal = 502;
        Rango_Medicion_Min = 0;
        Rango_Medicion_Max = 359.9;
    ...
    void wind_direction_standard_deviation_Grados() {  //503
        Canal = 503;
        Rango_Medicion_Min = 0;
        Rango_Medicion_Max = 359.9;
    ...
    void wind_value_quality_Porciento() {  //805
        Canal = 805;
        Rango_Medicion_Min = 0;
        Rango_Medicion_Max = 100;
    ...
    void wind_value_quality_fast() {  //806
        Canal = 806;
        Rango_Medicion_Min = 0;
        Rango_Medicion_Max = 100;
    ...
    void compass_heading_Grados() {  //510
        Canal = 510;
        Rango_Medicion_Min = 0;
...
//++ Precipitacion Cantidad
    ...
    void Precipitation_Quantity_Absolute_Litros_m2() {  //600
        Canal = 600;
        Rango_Medicion_Min = 0;
    ...
    void Precipitation_Quantity_Absolute_mm() {  //620
        Canal = 620;
        Rango_Medicion_Min = 0;
        Rango_Medicion_Max = 100000;
    ...
    void Precipitation_Quantity_Absolute_inches() {  //640
        Canal = 640;
        Rango_Medicion_Min = 0;
    ...
    void Precipitation_Quantity_Absolute_mil() {  //660
        Canal = 660;
        Rango_Medicion_Min = 0;
    ...
    void Precipitation_Quantity_Diferencial_Litros_m2() {  //605
        Canal = 605;
        Rango_Medicion_Min = 0;
        Rango_Medicion_Max = 100000;
    ...
    void Precipitation_Quantity_Diferencial_mm() {  //625
        Canal = 625;
        Rango_Medicion_Min = 0;
        Rango_Medicion_Max = 100000;
    ...
    void Precipitation_Quantity_Diferencial_inches() { //645
        Canal = 645;
        Rango_Medicion_Min = 0;
        Rango_Medicion_Max = 3937;
    ...
    void Precipitation_Quantity_Diferencial_mil() {  //665
        Canal = 665;
        Rango_Medicion_Min = 0;
        Rango_Medicion_Max = 3937008;
...
//++ Precipitacion Intensidad
    ...
    void Precipitation_Intensity_lm2H() {  //800
        Canal = 800;
        Rango_Medicion_Min = 0;
    ...
    void Precipitation_Intensity_mmH() {  //820
        Canal = 820;
        Rango_Medicion_Min = 0;
        Rango_Medicion_Max = 200;
    ...
    void Precipitation_Intensity_inH() {  //840
        Canal = 840;
        Rango_Medicion_Min = 0;
    ...
    void Precipitation_Intensity_milH() {  //860
        Canal = 860;
        Rango_Medicion_Min = 0;
